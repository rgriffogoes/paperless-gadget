...
Unfortunatelly, the Gadget mode was never stable enough (e.g.: usb mass storage not detected by host device, files not updated, etc), and this setup was abandonned.

Other had success, so please see full [discussio](https://github.com/paperless-ngx/paperless-ngx/discussions/3946) in the main repo. 
